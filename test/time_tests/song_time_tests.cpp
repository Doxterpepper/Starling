...
TEST_CASE("00 seconds", "[ui]") {
  ...
  for (size_t time_seconds = 0; time_seconds < expected_strings.size();
       time_seconds++) {
...
TEST_CASE("00 hours", "[ui]") {
  std::vector<std::string> expected_strings = {
      "00:00",    "01:00:00", "02:00:00", "03:00:00", "04:00:00", "05:00:00",
...
TEST_CASE("00 hours and 00 minutes", "[ui]") {
  std::vector<std::string> expected_strings = {
      "00:00",    "01:01:00", "02:02:00", "03:03:00", "04:04:00", "05:05:00",
