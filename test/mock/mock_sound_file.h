...
public:
  ...
  size_t bits_per_sample() const override { return bps; }
  ...
  size_t bytes_per_block() const override { return bpb; }

  size_t sound_length() const override { return 0; }

  size_t current_time() const override { return 0; }

  std::string name() const override { return "test"; }

  void seek_song(size_t) override {}

  void reset() override { reset_call_count++; }

  size_t reset_called() { return reset_call_count; }

  void set_frequency(size_t new_freq) { freq = new_freq; }

  void set_chan(size_t new_chan) { chan = new_chan; }

  void set_bps(size_t new_bps) { bps = new_bps; }

  void set_bytes_per_block(size_t bytes) { bpb = bytes; }
