...
TEST_CASE("Read wav header.", "[wav]") {
  ...
  //
  // Note: The time to create a wav file will depend on the speed of the storage
  // device. In my case, I'm seeing times on average of 36 microseconds.
  //
  auto creation_duration =
      std::chrono::duration_cast<std::chrono::microseconds>(end_wav_creation -
                                                            start_wav_creation);
