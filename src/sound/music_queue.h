...
namespace starling
{
    ...
    public:
        ...
        //
        // Next could iterate to end, resulting in a nullptr from current_song. This kinda makes sense,
        // if you increment the songs, eventually you run out of songs and playback stops.
        //
        void next()
        {
            std::lock_guard<std::mutex> guard(QueueLock);
